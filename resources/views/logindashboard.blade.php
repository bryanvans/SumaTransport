...
<!-- Mirrored from themesbrand.com/minia/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Jun 2024 05:55:57 GMT -->
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="dashboardassets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Minia</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="mt-4 pt-2" action="https://themesbrand.com/minia/layouts/index.html">
                                            ...
                                            <div class="mb-3">
                                            <a href="/dashboard"><button class="btn btn-primary w-100 waves-effect waves-light" type="button">Log In</button></a>
                                            </div>
                                        </form>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Don't have an account? <a href="/signup" class="text-primary fw-semibold">Signup now</a></p>
                                        </div>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="dashboardassets/images/users/avatar-1.jpg" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                </div>
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="dashboardassets/images/users/avatar-2.jpg" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                </div>
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <img src="dashboardassets/images/users/avatar-3.jpg"
        ...
        <!-- password addon init -->
        <script src="dashboardassets/js/pages/pass-addon.init.js"></script>
