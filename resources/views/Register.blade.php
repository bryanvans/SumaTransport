...
<body class="bg-gray-900 bg-opacity-75">
    ...
    <div class="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div class="mt-6">
            <a href="/auth/google" class="flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-full w-full transition duration-300 ease-in-out shadow-md hover:shadow-lg">
        ...
        <div class="text-center mt-6">
            <p class="text-gray-400">Sudah punya akun? 
                <a href="login" class="text-blue-400 hover:text-blue-600 transition font-semibold">Login di sini</a>
            </p>
        </div>
