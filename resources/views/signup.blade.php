...
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <div class="mt-5 text-center"><p class="text-muted mb-0">Already have an account? 
                                            <a href="/logindashboard" class="text-primary fw-semibold">Login</a></p>
                                        </div>
        ...
        <!-- validation init -->
        <script src="dashboardassets/js/pages/validation.init.js"></script>
